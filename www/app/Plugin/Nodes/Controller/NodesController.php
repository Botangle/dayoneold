 ...
 */
	public function beforeFilter() {
		...
		$this->Security->unlockedActions= array('admin_toggle','reportbug');
 ...
 */
	...
	public function reportbug(){
		 if (!empty($this->request->data)) { 
			...
			$template = "report";
			$error = $this->request->data['page']['error'];
			$to="contactus@botangle.com";
			...
			if ($emailSent) {
				$this->Session->setFlash(__d('croogo', 'Thanks for submitting your bug report!'), 'default', array('class' => 'success'));
