...
var myCountdown1 = new Countdown({
			 ...
			 <?php if($timeduration <= 0 ){ ?>
			  ...
			  if($this->Session->read('Auth.User.role_id')==4){ ?>
				 <iframe src="http://www.twiddla.com/api/start.aspx?sessionid=<?php echo $twiddlaid?>&controltype=2" frameborder="0" width="787" height="600" style="border:solid 1px #555;"></iframe> 
			 <?php } else {?>
				 <iframe src="http://www.twiddla.com/api/start.aspx?sessionid=<?php echo $twiddlaid?>&controltype=1&guestname=deep" frameborder="0" width="787" height="600" style="border:solid 1px #555;"></iframe> 
			 <?php }
			}?>
            </div>
            </div>
