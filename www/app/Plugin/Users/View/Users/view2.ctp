	...
	<div class="container">
		...
		<div class="row-fluid">
			<div class="span9 PageLeft-Block">
				<div class="row-fluid">
					<div class="span4"><?php if (file_exists(WWW_ROOT . 'uploads' . DS . 'users' . DS . $user['User']['id'] . DS . 'profile' . DS . $user['User']['profilepic']) && $user['User']['profilepic'] != "") { ?>
						...
						<?php } ?></div>
					<div class="span8">
						<p class="FontStyle28 color1"><?php echo $user['User']['name'] ?><br /><?php echo $user['User']['username'] ?>
