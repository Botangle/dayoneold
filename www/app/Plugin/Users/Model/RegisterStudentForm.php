...
class RegisterStudentForm extends AppFormModel {
    ...
    public function save($data = null, $validate = true, $fieldList = array()) {
        ...
        $data = $data['RegisterStudentForm'];
        $data['User'] = $data;

        // Translation layer because our original DB was broken
        $data['User']['name'] = $data['User']['firstname'];
        $data['User']['lname'] = $data['User']['lastname'];
...
//        if (isset($this->data['RegisterStudentForm']['password'])) {
//            if ($this->data['RegisterStudentForm']['password'] != $check['verify_password']) {
