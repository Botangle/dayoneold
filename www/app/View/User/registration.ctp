         ...
         <?php echo $this->Session->flash();
            ...
            <div class="control-group">
              ...
              <div class="control-group required">
                ...
                <div class="controls">
                  <textarea class="textarea" rows="3" id="select-subject" placeholder="type your subjects"></textarea>
                  <br>
              ...
              <div class="control-group required">
                ...
                <div class="controls">
					<?php echo $this->Form->input('name',array('label' => false,'class'=>'textbox','placeholder'=>__('First Name')));?>              
              ...
              <div class="control-group required">
                ...
                <div class="controls">
					<?php echo $this->Form->input('lname',array('label' => false,'class'=>'textbox','placeholder'=>__('Last Name')));?>              
              ...
              <div class="control-group  required">
                ...
                <div class="controls">
					<?php echo $this->Form->input('email',array('label' => false,'class'=>'textbox','placeholder'=>__('Email')));?>
              ...
              <div class="control-group required">
                ...
                <div class="controls">
					<?php echo $this->Form->textarea('qualification',array('label' => false,'class'=>'textarea','placeholder'=>__('type your subjects'),'rows'=>3));?>
              ...
              <div class="control-group required">
                ...
                <div class="controls">
				<?php echo $this->Form->textarea('teaching_experience',array('label' => false,'class'=>'textarea','placeholder'=>__('type your Experience'),'rows'=>3));?>
                </div>
              </div>
              <div class="control-group required">
                <label class="control-label" for="postalAddress"><?php echo __("Extracurricular Interests")?>:</label>
                <div class="controls">
				<?php echo $this->Form->textarea('extracurricular_interests',array('label' => false,'class'=>'textarea','placeholder'=>__('type your Extracurricular Interests'),'rows'=>3));?>
                </div>
              </div>
              ...
              <div class="control-group required">
                ...
                <div class="controls">
					<?php echo $this->Form->input('Confpassword',array('label' => false,'class'=>'textbox','type'=>'password','placeholder'=>__('Password')));?>              
            ...
            <div class="control-group form-actions">
              <button type="submit" class="btn btn-primary" onclick="return validatefrom.validation('UserRegistrationForm')">Create My Account</button>
