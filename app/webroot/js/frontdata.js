 ...
 *
 * This seems to be custom-written code for validating a front-facing form.
 *
 * The code doesn't look bad at a first glance... probably can keep this.
 */
            ...
            if (input.attr('offsetWidth') != 0) {
                ...
                switch (inputType) {
                    ...
                    case 'text':
                        ...
                        var fieldOK = true;
                        if (validatefrom.isRequired(input) && !isFieldValid) {
                            fieldOK = false;
                        }
                        if (validatefrom.isFilled(input) && !isFieldValid) {
                            fieldOK = false;
                        }
