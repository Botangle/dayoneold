...
<head>
    <meta name="viewport"
          content="user-scalable=0,width=device-width, minimum-scale=1.0, maximum-scale=1.0, initial-scale=1.0"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title><?php echo $mobile_language[0]; ?></title>
    <link type="text/css" href="<?php echo BASE_URL; ?>css.php?type=extension&name=mobile" rel="stylesheet"
          charset="utf-8">
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
    <script type="text/javascript" charset="utf-8"
            src="<?php echo BASE_URL; ?>js.php?type=extension&name=mobile&callbackfn=mobilewebapp"></script>
    <script>
...
<div data-role="page" id="buddy" style="background:inherit;">
    ...
    <div data-role="content" id="wocontent">
        <div id="woscroll">
            <ul id="wolist" data-role="listview" data-filter="true"
                data-filter-placeholder="<?php echo $mobile_language[15]; ?>">
            </ul>
    ...
    <div data-role="footer" data-position="fixed" id="buddyFooter">
        <div data-role="navbar" class="nav-glyphish-example">
            <ul>
                <li>
                    <a data-transition="none" data-icon="custom" id="buddy_link" class="chatlink"
                       href="#buddy"><?php echo $mobile_language[20]; ?></a>
                </li>
                <li>
                    <a data-transition="none" data-icon="custom" class="chatroomlink"
                       href="#lobby"><?php echo $mobile_language[21]; ?></a>
                </li>
            </ul>
        </div>
    </div>
...
<div data-role="page" id="chat" style="background:inherit;">
    <div id="chatheader" class="pageHeader" data-role="header" data-position="fixed">
        <a data-role="button" data-icon="back" data-iconpos="notext"
           onclick="javascript:loadChatboxReverse()"><?php echo $mobile_language[24] ?></a>
...
<div data-role="page" id="lobby" style="background:inherit;">
    <div class="pageHeader" data-role="header" data-position="fixed">
        ...
        <?php if ($allowUsers == '1'): ?>
            <a href="javascript:void(0);" data-role="button" data-icon="plus" data-iconpos="notext" class="ui-btn-right"
               onclick="javascript:createChatroom()"></a>
        <?php endif; ?>
    </div>
    <div data-role="content" id="lobbycontent">
        <div id="lobbyscroller">
            <ul id="lobbylist" data-role="listview" data-filter="true"
                data-filter-placeholder="<?php echo $mobile_language[16]; ?>">
            </ul>
        </div>
    </div>
    <div data-role="footer" data-position="fixed" id="lobbyFooter">
        <div data-role="navbar" class="nav-glyphish-example">
            <ul>
                <li><a data-transition="none" data-direction="reverse" data-icon="custom" class="chatlink"
                       href="#buddy"><?php echo $mobile_language[20]; ?></a></li>
                <li><a data-transition="none" data-icon="custom" id="lobby_link" class="chatroomlink"
                       href="#lobby"><?php echo $mobile_language[21]; ?></a></li>
            </ul>
        </div>
    </div>
</div>
...
<div data-role="page" id="chatroom" style="background:inherit;">
    <div class="pageHeader" id="chatroomheader" data-role="header" data-position="fixed">
        <a data-role="button" data-icon="back" data-iconpos="notext"
           onclick="javascript:leaveChatroom();loadLobbyReverse();"><?php echo $mobile_language[24] ?></a>
        <span id="chatroomName"></span>
        <a id="showUserButton" data-role="button"
           onclick="javascript:showChatroomUser();"><?php echo $mobile_language[23] ?></a>
    </div>
    ...
    <div id="chatroomfooter" class="ui-footer ui-bar-d ui-footer-fixed slideup">
        <form id="chatroommessageForm" onsubmit="#" data-ajax="false">
            <input id="chatroommessage" type="text" name="chatmessage"
                   placeholder="<?php echo $mobile_language[9]; ?>"/>
        </form>
    </div>
</div>
...
<div data-role="page" id="chatroomuser" style="background:inherit;">
    <div id="chatroomuserheader" class="pageHeader" data-role="header" data-position="fixed">
        <a data-role="button" data-icon="back" data-iconpos="notext"
           onclick="javascript:loadChatroomReverse();crscrollToBottom();"><?php echo $mobile_language[24] ?></a>
...
<div data-role="page" id="createChatroom" style="background:inherit;">
    <div class="pageHeader" data-role="header" data-position="fixed">
        <a data-role="button" data-icon="back" data-iconpos="notext"
           onclick="javascript:loadLobbyReverse()"><?php echo $mobile_language[24] ?></a>
    ...
    <div data-role="content" style="font-size:13px;">
        <form id="createChatroomForm" onsubmit="return false" data-ajax="false">
            ...
            <div id="createChatroomField" data-role="fieldcontain" style="padding-bottom:10px;">
                <button id="createChatroomButton"
                        onclick="javascript:createChatroomSubmit()"><?php echo $chatrooms_language[33]; ?></button>
            </div>
        </form>
    </div>
</div>
