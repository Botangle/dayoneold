...
temp += '
    <li id="lobbylist_'+room.id+'" class="ui-li ui-li-static ui-body-c" onclick="javascript:chatroom(\''+room.id+'\',\''+urlencode(shortname)+'\',\''+room.type+'\',\''+room.i+'\',\''+room.s+'\');" data-filtertext="'+longname+'">'+'
        ...
        <span class="lobby_room_5 ui-li-count">0</span>
...
$("#currentroom_convotext").append('
    <div class="cometchat_chatboxmessage me" id="cometchat_message_'+incomingid+'">
        <span class="cometchat_chatboxmessagefrom">
            <strong>'+fromname+'</strong>
        '+separator+'</span>
        <div class="userSeperator"></div>
...
if (minute
	...
	if (date != todaysDay) {
		return '
        <span class="cometchat_ts">('+hour+":"+minute+ap+' '+date+type+' '+months[month]+')</span>
    ';
    } else {
