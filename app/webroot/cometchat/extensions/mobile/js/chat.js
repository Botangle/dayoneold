...
buddylisttemp[buddy.s] += '
    <li id="onlinelist_'+buddy.id+'" class="ui-li ui-li-static ui-body-c ui-li-has-count ui-li-has-icon" onclick="javascript:jqcc.mobilewebapp.loadPanel(\''+buddy.id+'\')" data-filtertext="'+longname+'">
        <img src="images/cleardot.gif" class="ui-li-icon status status-'+buddy.s+' ">
            <span class="longname">'+longname+'</span>
            <span class="ui-li-aside">
                <img src="'+buddy.a+'" class=" avatarimage"/>
            </span>
            <span class="newmessages ui-li-count">'+buddyListMessages[buddy.id]+'</span>
        </li>
    ';
    ...
    longname = data.n;
    var buddylist = '
        <li id="onlinelist_'+data.id+'" onclick="javascript:jqcc.mobilewebapp.loadPanel(\''+data.id+'\')" data-filtertext="'+longname+'">
            <img src="images/cleardot.gif" class="ui-li-icon status status-'+data.s+' ">
                <span class="longname">'+longname+'</span>
                <span class="ui-li-aside">
                    <img src="'+buddy.a+'" class=" avatarimage"/>
                </span>
                <span class="newmessages ui-li-count">0</span>
            </li>
        ';
        ...
        temp += ('
            <li>
                <div class="cometchat_chatboxmessage '+selfstyle+' '+self+'" id="cometchat_message_'+incoming.id+'">'+messagefrom+'
                    <span class="cometchat_chatboxmessagecontent'+selfstyle+'">'+incoming.message+'</span>
                '+'</div>
