    ...
    <div class="span12 extensions-themes">
        ...
        <div class="current-theme row-fluid">
            <div class="screenshot span4">
                ...
                $this->Html->image('/theme/' . Configure::read('Site.theme') . '/img/' . $currentTheme['screenshot'],
        ...
        <div class="available-themes row-fluid">
            ...
            <ul>
                ...
                <li class="span12">';
                    ...
                    echo $this->Html->tag('div', $this->Html->image($theme['screenshot'], array('class' =>
                    'img-polaroid')), array('class' => 'screenshot span4'));
                    } else {
                    if (isset($theme['screenshot'])):
                    echo $this->Html->tag('div', $this->Html->image('/theme/' . $themeAlias . '/img/' .
                    $theme['screenshot'], array('class' => 'img-polaroid')), array('class' => 'screenshot span4'));
                    endif;
                    }
                    ...
                    $out .= $this->Html->tag('p', __d('croogo', 'Regions supported: ') . implode(', ',
                    $theme['regions']), array('class' => 'regions'));
                    endif;
