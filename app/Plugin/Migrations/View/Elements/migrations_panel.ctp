...
<div class="code-table">
    ...
    ?>
    <div class="migration-<?php echo empty($info['migrated']) ? 'unapplied' : 'applied';?>"
         style="background: <?php echo $status['color']; ?> url(<?php echo $status['image']; ?>) 5px 3px no-repeat; border-bottom: solid #ccc 1px; line-height: 1.75em; padding-left: 27px;">
