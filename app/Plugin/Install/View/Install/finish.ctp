<div class="install">
    ...
    <p>
        <?php echo __d('croogo', 'Admin panel: %s', $this->Html->link(Router::url('/admin', true), Router::url('/admin',
        true))); ?>
    </p>
    ...
    <blockquote>
        ...
        <ul class="bullet">
            ...
            <li><?php echo $this->Html->link('Croogo Google Group', 'https://groups.google.com/forum/#!forum/croogo');
                ?>
            </li>
        </ul>
    </blockquote>
