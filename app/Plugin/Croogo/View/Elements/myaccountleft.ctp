...
<div class="span3 LeftMenu-Block">
    <ul>
        <li><a href="<?php echo $this->webroot?>users/messages" title="Messages"
               class="<?php echo $accountmessages?>"><?php echo __('Messages')?><span class="badge pull-right"><?php
		
		echo $this->User->Getunreadmessage($this->Session->read('Auth.User.id')); ?></span></a></li>
        <li><a href="<?php echo $this->webroot?>users/lessons" title="Lessons" class="<?php echo $accountLessons?>">Lessons<span
        ...
        <li><a href="<?php echo $this->webroot?>/users/invite" title="Lessons" class="<?php echo $accountinvite?>">Invite
            Users<span class="badge pull-right"><?php
