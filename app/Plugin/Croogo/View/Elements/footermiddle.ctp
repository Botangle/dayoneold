        ...
        <div class="row-fluid">
            ...
            <div class="span5 social-updates">
                <div class="twitter-box">
                    ...
                    <?php echo $this->Html->image('/croogo/img/twitter-update.png');?>
                </div>
                <div class="facebook-box">
                    <p class="title1">Likes on Facebook</p>

                    <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fphelixportfolio.com%2Fdemos%2Fbotangle%2F&amp;width=401&amp;layout=standard&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=35"
                            scrolling="no" frameborder="0"
                            style="border:none; overflow:hidden; width:401px; height:35px;"
...
$news = $this->Custom->getNewsList();
            ...
            <div class="span4 latest-news-box">
                <div class="latest-news-box">
                    ...
                    <?php if(!empty($news)){
			foreach($news as $k=>$v){ ?>
                    <div class="media latest-news1"> <?php /*?><a href="#" class="pull-left"><?php echo $this->
                        Html->image('/croogo/img/date.png"'); ?></a><?php */
		  ...
		  ?>
                        ...
                        <div class="media-body">
                            ...
                            <a href="<?php echo $this->webroot?>news/detail/<?php echo str_replace("
                            ","-",$v['News']['title'])?>/<?php echo $v['News']['id']?>">Read more</a></div>
                    </div>
                    <?php }
		  }?>
