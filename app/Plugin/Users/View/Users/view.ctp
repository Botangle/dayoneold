    ...
    <div class="row-fluid">
		...
		foreach($subject as $k=>$v){
            ...
            <div class="row-fluid">
                ...
                <div class="span3"><span
                        class="color1"><?php echo $lessonClasscount[0][0]['totalrecords']?> <?php echo __("Classes")?></span>
                </div>
            </div>
    ...
    <div class="row-fluid">
      <span class="span12 profile-tabs">
            ...
            <div id="myTabContent" class="tab-content">
			   ...
			   echo $lessonClasscount[0][0]['totalrecords']?> &nbsp; &nbsp; | &nbsp; &nbsp; Total Time of
                        Classes: <?php echo $lessonClasscount[0][0]['totalduration']?> hours
                    </div>
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $review['User']['id']. DS . 'profile'. DS  .$review['User']['profilepic']) && $review['User']['profilepic']!=""){ ?>
                        ...
                        <div class="span2">
                            <p><input type="number" name="your_awesome_parameter" id="some_id" class="rating"
                                      value="<?php echo $review['Review']['rating']?>"/></p>
                    ...
                    <div class="Myclass-list row-fluid">
                        <div class="span2"><?php echo __("No reviews yet")?></div>
                    </div>
                    <?php } ?>
                </div>
