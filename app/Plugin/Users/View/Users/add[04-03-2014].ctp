...
<div class="Signup">
    ...
    <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('username',array('class'=>'textbox','placeholder'=>"First Name",'label' =>
                false));?>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('name',array('class'=>'textbox','placeholder'=>"Last Name",'label' =>
                false));?>
            </div>
        </div>
        <div class="control-group">
    ...
    <div class="control-group">
        <div class="controls">
            <label class="checkbox">
                ...
                <?php echo __("&nbsp;I agree with Botangle's <a href='/demos/botangle/privacy'>Terms of Use and Privacy
                Policy.</a>")?>.</label>
        </div>
    </div>
