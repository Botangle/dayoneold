    ...
    <div class="PageLeft-Block">
        ...
        <div class="Lesson-row active">
		  ...
		  if($this->Session->read('Auth.User.role_id')==2 && $v['Lesson']['laststatus_tutor']==1){
                    ...
                    if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $v['User']['id']. DS . 'profile'. DS
                    .$v['User']['profilepic']) && $v['User']['profilepic']!=""){ ?>
        ...
        <div class="Lesson-row">
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $v['User']['id']. DS . 'profile'. DS  .$v['User']['profilepic']) && $v['User']['profilepic']!=""){ ?>
			...
			if($this->Session->read('Auth.User.role_id')==2 && $v['Lesson']['is_confirmed']==0){
                ...
                ?>
                <a href="<?php echo $url?>" class="btn btn-primary btn-primary3" <?php echo $calss; $url?>>Go To
                Lesson </a>
                <?php }
            ...
            <div class="span2 mark"> ';
                ...
                btn-primary3','style'=>'width:125px','disabled'=>$usedisabled)
                ); echo '
            </div>
            ';
            } ?>
        ...
        <div class="row-fluid">
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $v['User']['id']. DS . 'profile'. DS  .$v['User']['profilepic']) && $v['User']['profilepic']!=""){ ?>
            ...
            <div class="span2 mark lessonrating"> <?php
                ...
                ?>
                <p>Rating: <input type="number" name="your_awesome_parameter" id="<?php echo $v['Lesson']['id'] ?>"
                                  value="<?php echo $reviws['Review']['rating'] ?>" class="rating"/></p>
                <?php } ?>
            </div>
