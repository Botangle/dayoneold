...
if(isset($categoryname) && ($categoryname!="")){
	$userurlname = $categoryname;
      ...
      <div class="span8 Breadcrame"> <?php echo __("Home")?> // <?php if (isset($this->Paginator) && isset($this->request['paging'])):  
    ...
    <div class="row-fluid">
      <div class="span3 LeftMenu-Block">
		...
		foreach($category as $k=>$v){ ?>
			<li><a href="<?php echo $this->webroot?>users/topchart/<?php echo $v['Category']['id']?>/<?php echo $online?>" title="Lessons"><?php echo $v['Category']['name']?><span class="badge pull-right"><?php $resultsCount = $this->User->getCategoryusercount($v['Category']['id']);
			echo $resultsCount;
