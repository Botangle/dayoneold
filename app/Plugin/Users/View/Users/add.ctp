...
<style>
    .security {
        background-image: url(images/password-security.jpg)
    }
...
<div class="Signup">
    ...
    <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->textarea('subject',array('class'=>'textarea','placeholder'=>'Type Your
                Subjects','rows'=>3));?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('username',array('class'=>'textbox','placeholder'=>"Username",'label' =>
                false));?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('name',array('class'=>'textbox','placeholder'=>"First Name",'label' =>
                false));?>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('lname',array('class'=>'textbox','placeholder'=>"Last Name",'label' =>
                false));?>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('email',array('class'=>'textbox','placeholder'=>"email@email.com",'label'
                => false));?>
        ...
        <div id="signupTuter">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->textarea('qualification',array('class'=>'textarea','placeholder'=>"Type Your
                    Qualification"));?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->
                    Form->textarea('teaching_experience',array('class'=>'textarea','placeholder'=>"Teaching
                    Experience"));?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->
                    Form->textarea('extracurricular_interests',array('class'=>'textarea','placeholder'=>"Extracurricular
                    Interests"));?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->input('other_experience',array('class'=>'textbox','placeholder'=>"English
                    with a Concentration in Theater",'label' => false));?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->
                    Form->input('university',array('class'=>'textbox','placeholder'=>"Barnard/University, Class of
                    2013",'label' => false));?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->textarea('expertise',array('class'=>'textarea','placeholder'=>"Top
                    Subjects"));?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('password',array('class'=>'textbox','placeholder'=>"Password",'label' =>
                false));?>
            </div>
            <div class="controls">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->
                Form->input('verify_password',array('type'=>'password','class'=>'textbox','placeholder'=>"Confirm
    ...
    <div class="control-group">
        <div class="controls">
            <label class="checkbox">
                ...
                <label><?php echo __("&nbsp;I agree with Botangle's <a href='/demos/botangle/privacy'>Terms of Use and
                    Privacy Policy.</a>")?>.</label></label>
        </div>
    </div>
        ...
        <div class="control-group">
            <div class="controls">
                <label class="checkbox termcls">
                    ...
                    <?php echo $this->Form->checkbox('terms', array('hiddenField' => false));?>
                    <label><?php echo __("&nbsp;I agree with Botangle's <a href='/demos/botangle/privacy'>Terms of Use
                        and Privacy Policy.</a>.")?></label></label>
            </div>
        </div>
        <div class="control-group form-actions">
            <?php
