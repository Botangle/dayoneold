    ...
    <div class="container">
        ...
        <div class="row-fluid">
		 ...
		 $this->request->data = $this->Session->read("Auth.User");
                            ...
                            echo
                            $this->Form->input('id',array('value'=>isset($ratedata['UserRate']['id'])?$ratedata['UserRate']['id']:"",'type'=>'hidden'));
                            echo
                            $this->Form->input('userid',array('value'=>$this->request->data['id'],'type'=>'hidden'));
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio inline span4">
                                        <input type="radio" name="data[UserRate][price_type]"
                                               value="permin"  <?php echo $phchecked?>>
                                        Per Minute Price </label>
                                    <label class="radio inline span4 mar0">
                                        <input type="radio" name="data[UserRate][price_type]"
                                               value="perhour" <?php echo $pchecked?>>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls span5">
                                        <?php echo $this->
                                        Form->input('rate',array('class'=>'textbox','placeholder'=>"rate",'label' =>
                                        false,'value'=>$rate,'type'=>'text'));?>
