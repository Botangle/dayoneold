...
<div class="modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
     style="left:40%; width:auto; right:20%">
    <div class="PageLeft-Block">
        ...
        /*echo $this->Form->input('id',array('class'=>'textbox','placeholder'=>"Student Name",'label' =>
        false,'value'=>$Lesson['Lesson']['id']));*/
        if($Lesson['Lesson']['parent_id'] == 0){
        $Lesson['Lesson']['parent_id'] = $Lesson['Lesson']['id'];
        }

        echo $this->Form->input('parent_id',array('class'=>'textbox','placeholder'=>"Student Name",'label' =>
        false,'value'=>$Lesson['Lesson']['parent_id'],'type'=>'hidden'));
        ?>
        ...
        <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->input('tutor',array('class'=>'textbox','placeholder'=>"Student Name",'label'
                    => false,'disabled'=>'disabled','value'=>$Lesson['User']['username']));
                    echo $this->Form->hidden('tutor',array('class'=>'textbox','placeholder'=>"Student Name",'label' =>
                    false,'id'=>'LessonTutorValue','value'=>$Lesson['User']['id']))
                    ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->input('lesson_date',array('class'=>'textbox','placeholder'=>"Tutor",'label'
                    => false,'id'=>'dtp_input2','type'=>'hidden','value'=>$Lesson['Lesson']['lesson_date']));?>
                    ...
                    <div class=" input-append date form_date" data-date="" data-date-format="dd MM yyyy"
                        ...
                        <input size="16" type="text" value="<?php echo $Lesson['Lesson']['lesson_date'] ?>" readonly
                               class="textbox2" style="width:57%"/>
                        <span class="add-on" style="height:44px"><i class="icon-remove"></i></span>
                        <span class="add-on" style="height:44px"><i class="icon-th"></i></span>

                    </div>
                    <?php echo $this->Form->input('lesson_time',array('class'=>'textbox','placeholder'=>"Tutor",'label'
                    => false,'id'=>'dtp_input3','type'=>'hidden','value'=>$Lesson['Lesson']['lesson_time']));?>
                    <div class=" input-append date form_time" data-date="" data-date-format="hh:ii"
                        ...
                        <input size="16" class="textbox2" type="text"
                               value="<?php echo  $Lesson['Lesson']['lesson_time']?>" readonly>
                        <span class="add-on" style="height:44px"><i class="icon-remove"></i></span>
                        <span class="add-on" style="height:44px"><i class="icon-th"></i></span>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->input('duration',array('class'=>'textbox','placeholder'=>"Duration",'label'
                    => false,'value'=>$Lesson['Lesson']['duration']));?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $this->Form->input('subject',array('class'=>'textbox','placeholder'=>"Subject",'label' =>
                    false,'value'=>$Lesson['Lesson']['subject']));?>
            ...
            <div class="control-group">
                ...
                $options = array('Signle lesson' => 'Signle lesson','Daily' => 'Daily','Weekly' => 'Weekly');
                    $attributes = array('legend' => false,'checked' => $Lesson['Lesson']['repet'],'value'=>'Signle
                    lesson',
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    note','rows'=>3,'value'=>$Lesson['Lesson']['notes']));?>
                </div>
            </div>
        </div>
