...
if(isset($categoryname) && ($categoryname!="")){
	$userurlname = $categoryname;
            ...
            <div class="span8 Breadcrame"> <?php echo __("Home")?> // <?php if (isset($this->Paginator) &&
                isset($this->request['paging'])):

                echo $this->Paginator->counter(array(
                'format' => __d('croogo', 'Showing {:page} - {:current}, of {:count} total results ')
                ));
                endif?><!-- (225 online) --></div>
            <div class="span3 pull-right">
                <label class="checkbox online-checkbox">
                    <input type="checkbox"
                           id="isonline" <?php if(isset($online) && ($online!="")) { echo "checked='checked'"; } ?>>
...
<div id="main-content">
    <div class="container">
        ...
        <div class="row-fluid">
            <div class="span3 LeftMenu-Block">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $this->webroot?>users/topchart/" title="Messages">All Categories <span
                            class="badge pull-right" id="totalCategory">0</span></a></li>
                    <?php $totalResult = 0;
		if(!isset($online)){
			$online = "";
		}
		foreach($category as $k=>$v){ ?>
                    <li>
                        <a href="<?php echo $this->webroot?>users/topchart/<?php echo $v['Category']['id']?>/<?php echo $online?>"
                           title="Lessons"><?php echo $v['Category']['name']?><span
                                class="badge pull-right"><?php $resultsCount = $this->
                            User->getCategoryusercount($v['Category']['id']);
			echo $resultsCount;
					...
					foreach($userlist as $k=>$user){
                        ...
                        <div class="span4 search-result-box">
						 ...
						 ?>
                                    ...
                                    <?php }else{		 ?>
                                    <img src="<?php echo $this->webroot?>images/default.png" class="img-circle"
                                         alt="people">
                                    <?php } ?>
                                </a>
                            </div>
                            ...
                            <div class="search-result-options">
                                <div class="pull-left"><input type="number" name="your_awesome_parameter" id="some_id"
                                                              class="rating" data-clearable="0"
                                                              value="<?php echo round($user[0]['rating']) ?>"/></div>
