...
<div class="modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    echo
    $this->Form->input('rate_to',array('class'=>'rating','type'=>'hidden','label'=>false,'div'=>false,'value'=>$Lesson['Lesson']['created']));
    echo
    $this->Form->input('rate_by',array('class'=>'rating','type'=>'hidden','label'=>false,'div'=>false,'value'=>$Lesson['Lesson']['tutor']));
    echo
    $this->Form->input('lesson_id',array('class'=>'rating','type'=>'hidden','label'=>false,'div'=>false,'value'=>$Lesson['Lesson']['id']));
    ?>
    <div class="control-group"><label class="control-label" for="postalAddress"><?php echo __("Rate here")?></label>

        <div class="controls">
            <div class="span2 mark lessonratingdata">
                <?php echo $this->
                Form->input('rating',array('class'=>'rating','type'=>'number','label'=>false,'div'=>false));?>
            </div>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->textarea('reviews',array('class'=>'textarea','placeholder'=>'type your
            reviews','rows'=>3,'value'=>''));?>
        </div>
    </div>
    <div class="control-group form-actions">
        ...
        'data-dismiss'=>'modal','aria-hidden'=>'true','onclick'=>'removebackground()' ));?>
