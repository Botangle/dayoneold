<h2 class="hidden-desktop"><?php echo __d('croogo', 'Reset password'); ?>: <?php echo $this->data['User']['username'];
    ?></h2>
<?php
	$this->Html
    ...
    <div class="span8">
        ...
        <div class="tab-content">
            <div id="reset-password" class="tab-pane">
                ...
                echo $this->Form->input('verify_password', array('label' => __d('croogo', 'Verify Password'), 'type' =>
                'password', 'value' => ''));
                ?>
            </div>
