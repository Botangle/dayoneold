        ...
        <div class="row-fluid">
		 ...
		 if(file_exists(WWW_ROOT .  'uploads' . DS . $user['User']['id']. DS . 'profile'. DS  .$user['User']['profilepic']) && $user['User']['profilepic']!=""){ ?>
                    ...
                    <div class="span8">
                        ...
                        <p>Subject: <span class="tag01">Act</span> <span class="tag01">Pre-Algebra</span> <span
                                class="tag01">Music Theory</span> <span class="tag01">Music</span></p>

                        <p>Joined Classes: <span class="color1">20</span></p>

                        <p>Share: <span class="profile-share"><img src="<?php echo $this->webroot?>images/fb.png"
                                                                   alt="email"></span> <span class="profile-share"><img
                                src="<?php echo $this->webroot?>images/twitter.png" alt="email"></span> <span
                                class="profile-share"><img src="<?php echo $this->webroot?>images/mail.png" alt="email"></span>
                        </p>
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade" id="profile">
                    ...
                    <div class="Myclass-list row-fluid">
                        ...
                        <div class="span5">
                            "I tutored a student one-on-one as a member of the National Honor Society during my senior
                            year of high..."
                        </div>
                        <div class="span2">
                            <p><input type="number" name="your_awesome_parameter" id="some_id" class="rating"
                                      data-clearable="remove"/></p>
          ...
          <script>
            ...
            <div class="span3 PageRight-Block">
                ...
                <p class="student-subject"><a href="#">Calculus</a><br>
                    Received A's in all single variable and multivariable calculus classes, received a 5 on AP BC
                    Calculus
                </p>
