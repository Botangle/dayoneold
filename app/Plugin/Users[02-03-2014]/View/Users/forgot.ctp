    ...
    <div class="container">
        ...
        <div class="row-fluid">
            <div class="span9 PageLeft-Block">
                ...
                <p class="">No Problem, just fill in your email address below, and we'll send you an email to reset your
                    password!</p><br>

                <div class="Signup">
                    <?php echo $this->Form->create('User', array('url' => array('controller' => 'users', 'action' =>
                    'forgot'),'class'=>'form-inline form-horizontal','role'=>'form'));?>

                    <div class=" span8">
                        <?php
			echo $this->Form->input('email', array('class'=>'form-control
                        textbox1','placeholder'=>'email@email.com','label'=>false ));
                        ?>
