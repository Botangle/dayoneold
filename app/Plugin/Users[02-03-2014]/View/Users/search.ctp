    ...
    <div class="container">
        ...
        <div class="row-fluid">
				...
				if(!empty($users)){ 
					foreach($users as $k=>$user){
                        ...
                        <div class="span4 search-result-box">
                            <div class="search-result-img"><a
                                    href="<?php echo $this->webroot?>user/<?php echo $user['User']['username']?>">
                                <?php
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $user['User']['id']. DS . 'profile'. DS  .$user['User']['profilepic']) && $user['User']['profilepic']!=""){ ?>
                                ...
                                <?php }else{		 ?>
                                <img src="<?php echo $this->webroot?>images/people1.jpg" class="img-circle"
                                     alt="people">
                                <?php } ?></a>
