    ...
    <div class="container">
		...
		if(!empty($userData)){ 
				foreach($userData as $k=>$v){
                            ...
                            <a class="" title="jaindeepak"
                               href="/demos/botangle/users/messages/<?php echo $v['User']['username']; ?>">
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $v['User']['id']. DS . 'profile'. DS  .$v['User']['profilepic']) && $v['User']['profilepic']!=""){ ?>
                                        ...
                                        <div class="span8 sender-name">
                                            <?php /* echo $this->Html->link(__($v['User']['username']),
                                            '/users/messages/'.$v['User']['username'],
                                            array('class' => '', 'title' => __($v['User']['username']))); */?>

                                            <?php echo $v['User']['username']; ?>

                                            <br><span class="FontStyle11"><?php echo $this->
                                            User->GettimedifferencedayBase($v['Usermessage']['date']);?></span></div>
                                    </div>
                                </div>
		...
		if(!empty($sent_from)){
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $v['User']['id']. DS . 'profile'. DS  .$v['User']['profilepic']) && $v['User']['profilepic']!=""){ ?>
                                    ...
                                    <div class="span10 sender-text">
                                        ...
                                        <p class="msg-time"><?php echo $this->
                                            User->Gettimedifference($v['Usermessage']['date']);?></p>
                                    </div>
		 ...
		 if(file_exists(WWW_ROOT . DS . 'uploads' . DS . $v['User']['id']. DS . 'profile'. DS  .$v['User']['profilepic']) && $v['User']['profilepic']!=""){ ?>
                            ...
                            <?php echo $this->Form->create('Usermessage',array('class'=>'form-inline
                            ...
                            <div id="Write-msg">
                                ...
                                <?php echo $this->Form->textarea('body',array('class'=>'textarea','placeholder'=>"Type
                                Your message",'rows'=>3));?>
                                ...
                                <a class='' href='javascript:;'>
                                    ...
                                    Attach file
                                    <?php
			echo $this->Form->file('attached_files',array('style'=>'position:absolute;z-index:2;top:0;left:0;filter:
                                    alpha(opacity=0);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";opacity:0;background-color:transparent;color:transparent;'))
                                    ?>
                            ...
                            */ ?>
                            ...
                            <div class="span5 pull-right msg-send-btn"> <?php echo $this->Form->button(__("Send
                                Message"), array('type' => 'submit','class'=>'btn btn-primary'));
                                ?>
                            </div>
                        </div>
