        ...
        <div class=" row-fluid">
            ...
            <div class="span4 Servicebox" onclick="window.location.href=('<?php echo $this->webroot?>user/search')">
                ...
                <div class="service-text">
                    ...
                    <p>Work with someone instantly or schedule<br/> a lesson with your preferred tutor at a convenient
                        time. </p>
                </div>
            </div>
            <div class="span4 Servicebox" onclick="window.location.href=('<?php echo $this->webroot?>user/search')">
    ...
    <div class="container text-center">
        <div class="QuoteBlock row-fluid">
            <div class="span12"><span class="left">"</span>
                ...
                <p> Hi there, my name is Jack. I'm a college student by day, bike messenger by night, and I'm having
                    trouble with Chem 101. I live in Los Angeles, I used Botangle and now I'm at the top of my
                    class. </p>
...
<div class="row-fluid">
    ...
    <div class="span4 Tutor-list1">
        <div class="tutor-img"><a href="<?php echo $this->webroot?>user/<?php echo $user['User']['username']?>">
		 ...
		 if(file_exists(WWW_ROOT .  'uploads' . DS . $user['User']['id']. DS . 'profile'. DS  .$user['User']['profilepic']) && $user['User']['profilepic']!=""){ ?>
            <img src="<?php echo $this->webroot. 'uploads/'.$user['User']['id'].'/profile/'.$user['User']['profilepic'] ?> "
                 class="img-circle" alt="student" width="242px" height="242px" style="width:196; height:191px;">
            <?php }else{		 ?>
        ...
        <div class="tutor-title">
            <h3>
                <a href="<?php echo $this->webroot?>user/<?php echo $user['User']['username']?>"><?php echo ucfirst($user['User']['username']) ?></a>
            </h3>
        ...
        <div class="tutor-bio">
            ...
            <div class="social">
                <a href="#"><?php echo $this->Html->image('/croogo/img/facebook.png',array('class'=>'img-circle-left'));
                    ?></a>
                ...
                <a href="#"><?php echo $this->
                    Html->image('/croogo/img/trumbler.png',array('class'=>'img-circle-right')); ?></a>
            </div>
        </div>
    </div>
    <?php }
