...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var b = {timestamp: "D2LI", version: "4.1", revision: "80c139aa", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (a, e) {
            ...
            function j(b, m, o, n) {
                b = {name: a, sender: this, editor: b, data: m, listenerData: c, stop: o, cancel: n, removeListener: l};
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
            ...
            return g
        }, a = {}, g = {}, e = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, f = {}, i = {"#": 1}, j = {center: 1, dir: 1, noframes: 1};
        ...
        b(g, e, a, j);
        c = {a: c(a, {a: 1, button: 1}), abbr: a, address: g,
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var j =
                        this.$.getBoundingClientRect(), l = d.$.documentElement, n = l.clientTop || f.$.clientTop || 0, m = l.clientLeft || f.$.clientLeft || 0, o = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var m = c.startOffset, o = c.endOffset, k, h = this.guard, s = this.type, g = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var e = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), t = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(o) : d.getNext();
                this._.guardLTR = function (a, b) {
                    return(!b || !e.equals(a)) && (!t || !a.equals(t)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var F = n.type == CKEDITOR.NODE_ELEMENT ? n : n.getParent(), z = n.type == CKEDITOR.NODE_ELEMENT ? m ? n.getChild(m - 1) : null : n.getPrevious();
    ...
    (function () {
        ...
        }, d = {abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1}, f = CKEDITOR.dom.walker.bogus(), i = new CKEDITOR.dom.walker.whitespaces, j = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {clone: function () {
            ...
            var b = this.startContainer, c = this.endContainer, d = this.startOffset, h = this.endOffset, g = this.collapsed, e, f;
            ...
            return{start: b.getAddress(a),
                end: g ? null : c.getAddress(a), startOffset: d, endOffset: h, normalized: a, collapsed: g, is2: true}
            ...
            switch (a) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var y, u, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), I = function (a) {
                        var b = x(a);
                        b || (y = a);
                        return b
                    }, c = function (a) {
            ...
            if (!this.collapsed) {
                var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), h = this.startContainer, f = this.endContainer, g = this.startOffset, e = this.endOffset, i = 1, j = 1;
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    new CKEDITOR.dom.elementPath(this.startContainer, this.root), c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, h = c.block, f = null;
    ...
    (function () {
        ...
        var a = /^[\r\n\t ]+$/, g = CKEDITOR.dom.walker.bookmark(false, true), e = CKEDITOR.dom.walker.whitespaces(true), d = function (a) {
            return g(a) && e(a)
        };
    ...
    (function () {
        ...
        function g(a) {
            ...
            return a._.filterFunction = function (h, f, m, e, g, o, k) {
                ...
                if (f) {
                    var i = h.name, m = f.elements[i], v = f.generic, f = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {},
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, d) {
            ...
            var d = [], f = !c && this._.rules, m = this._.transformations, e = g(this), o = this.editor && this.editor.config.protectedSource, k = false;
            ...
            addTransformations: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (m = 0; m < b.length; ++m) {
                            ...
                            c.push({check: g == f ? null : g, left: o, right: typeof k == "string" ?
                                F(k) : k})
                        }
                        b = f;
                        d[b] || (d[b] = []);
                ...
                if (typeof a == "string") {
                    ...
                    e = {name: h.element, attributes: o, classes: o["class"] ? o["class"].split(/\s+/) : [], styles: e, children: []}
                }
        ...
        var r = {styles: 1, attributes: 1, classes: 1}, C = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"}, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, u = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, x = CKEDITOR.filter.transformationsTools = {sizeToStyle: function (a) {
    ...
    (function () {
        CKEDITOR.lang = {languages: {af: 1, ar: 1, bg: 1, bn: 1, bs: 1, ca: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, "en-au": 1, "en-ca": 1, "en-gb": 1, en: 1, eo: 1, es: 1, et: 1, eu: 1, fa: 1, fi: 1, fo: 1, "fr-ca": 1, fr: 1, gl: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, is: 1, it: 1, ja: 1, ka: 1, km: 1, ko: 1, ku: 1, lt: 1, lv: 1, mn: 1, ms: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, pt: 1, ro: 1, ru: 1, sk: 1, sl: 1, "sr-latn": 1, sr: 1, sv: 1, th: 1, tr: 1, uk: 1, vi: 1, "zh-cn": 1, zh: 1}, load: function (b, c, a) {
            ...
            var a = this.languages, c = c || navigator.userLanguage || navigator.language || b, g = c.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), e = g[1], g = g[2];
    ...
    CKEDITOR.ui.prototype = {add: function (b, c, a) {
        ...
        var g = this.items[b] = {type: c, command: a.command || null, args: Array.prototype.slice.call(arguments, 2)};
        CKEDITOR.tools.extend(g, a)
    }, get: function (b) {
        return this.instances[b]
    }, create: function (b) {
        var c = this.items[b], a = c && this._.handlers[c.type], g = c && c.command && this.editor.getCommand(c.command), a = a && a.create.apply(this, c.args);
        this.instances[b] = a;
        g && g.uiItems.push(a);
    ...
    (function () {
        ...
        function n(a) {
            ...
            if (d)var f =
                RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(f, ""), c = c + ("," + d);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {remove: function () {
            ...
            var c = this.parent.children, a = CKEDITOR.tools.indexOf(c, this), g = b.previous = this.previous, e = b.next = this.next;
            g && (g.next = b);
            e && (e.previous = b);
            c[a] = b;
    ...
    (function () {
        ...
        var c = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), a = {ol: 1, ul: 1}, g = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1});
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, f) {
            ...
            var k = new CKEDITOR.htmlParser, h = d instanceof CKEDITOR.htmlParser.element ? d : typeof d == "string" ? new CKEDITOR.htmlParser.element(d) : new CKEDITOR.htmlParser.fragment, s = [], w = [], v = h, t = h.name == "textarea", F = h.name == "pre";
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (a) {
            ...
            a.on("toHtml", function (b) {
                    var b = b.data, d = b.dataValue, d = t(d, a), d = o(d), d = k(d), d = d.replace(E, "$1cke:$2"), d = d.replace(L, "<cke:$1$2></cke:$1>"),
                        d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = b.context || a.editable().getName(), m;
        ...
        var F = /(?:&nbsp;|\xa0)$/,
            z = "{cke_protected}", q = CKEDITOR.dtd, p = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], A = CKEDITOR.tools.extend({}, q.$blockLimit, q.$block), r = {elements: {}, attributeNames: [
                [/^on/, "data-cke-pa-on"]
            ]}, C = {elementNames: [
                [/^cke:/, ""],
                [/^\?xml:namespace$/, ""]
        ...
        var u = /<(a|area|img|input|source)\b([^>]*)>/gi, x = /\b(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, I = /(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            G = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, E = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, Q = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, L = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, g = a.elementMode, l = a.fire("uiSpace", {space: "top", html: ""}).html, n = a.fire("uiSpace", {space: "bottom", html: ""}).html;
            ...
            b = CKEDITOR.dom.element.createFromHtml(e.output({id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: a.lang.editor,
                topHtml: l ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + l + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: n ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + n + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"}));
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var g = this.container, n = this.ui.space("contents"), m = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? g.getChild(1) : g;
    ...
    (function () {
        function b(b) {
            var c = b.editor, d = c.editable(), e = b.data.path, g = e.blockLimit, f = b.data.selection.getRanges()[0], i = c.config.enterMode;
        ...
        function e(b) {
            var c, d = b.getRanges()[0], b = b.root, e = d.startPath(), g = {table: 1, ul: 1, ol: 1, dl: 1}, f = CKEDITOR.dom.walker.bogus();
            if (e.contains(g)) {
                var i = d.clone();
                i.collapse(1);
        ...
        var n = function () {
                ...
                for (var i = j[i.getName()], l = 0, n = a.getChildren(), w = n.count(), s = -1, t = -1, D = 0, z = e.contains(j.$list); l < w; ++l) {
                    ...
                    if (b(e)) {
                        ...
                        if (z && h in CKEDITOR.dtd.$list)k = k.concat(c(e, d)); else {
                            ...
                            s == -1 && !f && (s = l);
                            f || (t = l);
                            k.push({isElement: 1, isLineBreak: D, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: h, allowed: f});
                            g = D = 0
                        }
            ...
            var j = CKEDITOR.dtd, l = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, z = CKEDITOR.tools.extend({}, j.$inline);
            delete z.br;
            return function (l, p, t) {
                ...
                if (!C.checkReadOnly()) {
                    var u = (new CKEDITOR.dom.elementPath(C.startContainer, C.root)).blockLimit || C.root, p = {type: p, dontFilter: y, editable: l, editor: r, range: C, blockLimit: u, mergeCandidates: [], zombies: []}, r = p.range, y = p.mergeCandidates, x, I, G, E;
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            g.on("contentDom", function () {
                var a = g.document, e = CKEDITOR.document, f = g.editable(), o = a.getBody(), m = a.getDocumentElement(), i = f.isInline(), j;
            ...
            var a = l ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var g = d.children, f, i, m = b.duplicate(), k = 0, j = g.length - 1, l = -1, n, y; k <= j;) {
                        ...
                        if (n > 0)j = l - 1; else if (n < 0)k = l + 1; else {
                            if (CKEDITOR.env.ie9Compat && f.tagName == "BR") {
                                ...
                                return{container: g[c ? "anchorNode" : "focusNode"], offset: g[c ? "anchorOffset" : "focusOffset"]}
                            }
                    ...
                    if (l == -1 || l == g.length - 1 && n < 0) {
                        ...
                        if (!e) {
                            f = g[g.length - 1];
                            return f.nodeType != CKEDITOR.NODE_TEXT ? {container: d, offset: g.length} : {container: f, offset: f.nodeValue.length}
                        }
    ...
    (function () {
            ...
            if (a.collapsed) {
                ...
                for (k.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (k = 0); k;) {
                    ...
                    if (k.equals(m)) {
                        ...
                        var q = k.type, r = q == CKEDITOR.NODE_ELEMENT ? k.getName() : null, p = r && k.getAttribute("contentEditable") == "false", t = r && k.getAttribute("data-nostyle");
        ...
        var q = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1,
            keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, p = {a: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, A = /\s*(?:;\s*|$)/, r = /#\((.+?)\)/g, C = CKEDITOR.dom.walker.bookmark(0, 1), y = CKEDITOR.dom.walker.whitespaces(1);
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {type: CKEDITOR.NODE_TEXT, getLength: function () {
        ...
        var c = this.$.parentNode, a = c.childNodes.length, g = this.getLength(), e = this.getDocument(), d = new CKEDITOR.dom.text(this.$.splitText(b), e);
    ...
    (function () {
        function b(a, b, c) {
            var d = a.serializable, f = b[c ? "endContainer" : "startContainer"], i = c ? "endOffset" : "startOffset", j = d ? b.document.getById(a.startNode) : a.startNode, a = d ? b.document.getById(a.endNode) : a.endNode;
    ...
    (function () {
        CKEDITOR.plugins.add("a11yhelp", {requires: "dialog", availableLangs: {en: 1, ar: 1, bg: 1, ca: 1, et: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, eo: 1, es: 1, fa: 1, fi: 1, fr: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, it: 1, ja: 1, km: 1, ku: 1, lt: 1, lv: 1, mk: 1, mn: 1, nb: 1, nl: 1, no: 1, pl: 1, pt: 1, "pt-br": 1, ro: 1, ru: 1, sk: 1, sl: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, "zh-cn": 1}, init: function (b) {
            var c = this;
        ...
        function v(a) {
            ...
            function c() {
                return{canUndo: !1, async: !0, exec: function (a, b) {
                    ...
                    "string" == typeof b ? c({type: "auto",
                        dataValue: b}, 1) : a.getClipboardData(c)
                }}
            }
            ...
            function j(d, b) {
                ...
                if (!c.getById("cke_pastebin")) {
                    var f = a.getSelection(), h = f.createBookmarks(), i = new CKEDITOR.dom.element(e.is("body") && !CKEDITOR.env.ie && !CKEDITOR.env.opera ? "body" : "div", c);
                    i.setAttribute("id", "cke_pastebin");
                    CKEDITOR.env.opera && i.appendBogus();
                    var o = 0, c = c.getWindow();
                    j ? (i.insertAfter(h[0].startNode), i.setStyle("display", "inline")) : (CKEDITOR.env.webkit ? (e.append(i), i.addClass("cke_editable"), o = (e.is("body") ? e : CKEDITOR.dom.element.get(i.$.offsetParent)).getDocumentPosition().y) : e.getAscendant(CKEDITOR.env.ie || CKEDITOR.env.opera ? "body" : "html", 1).append(i), i.setStyles({position: "absolute", top: c.getScrollPosition().y -
                        o + 10 + "px", width: "1px", height: Math.max(1, c.getViewPaneSize().height - 20) + "px", overflow: "hidden", margin: 0, padding: 0}));
    ...
    (function () {
            ...
            if (c) {
                for (var h = c.createBookmarks(), d = c.getRanges(!0), e = this.cssClassName, f, g, i = a.config.useComputedState, i = void 0 === i || i, k = d.length - 1; 0 <= k; k--) {
                    ...
                    for (f.enlargeBr = b != CKEDITOR.ENTER_BR; g = f.getNextParagraph(b == CKEDITOR.ENTER_P ? "p" : "div");) {
                        ...
                        var j = e && (g.$.className = CKEDITOR.tools.ltrim(g.$.className.replace(this.cssClassRegex, ""))), m = this.state == CKEDITOR.TRISTATE_OFF &&
                            (!i || l(g, !0) != this.value);
        ...
        CKEDITOR.plugins.add("justify", {init: function (a) {
            if (!a.blockless) {
                ...
                a.ui.addButton && (a.ui.addButton("JustifyLeft", {label: a.lang.justify.left, command: "justifyleft", toolbar: "align,10"}), a.ui.addButton("JustifyCenter", {label: a.lang.justify.center, command: "justifycenter", toolbar: "align,20"}), a.ui.addButton("JustifyRight", {label: a.lang.justify.right, command: "justifyright", toolbar: "align,30"}),
    ...
    (function () {
        var h, j = {modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function (a) {
            var g, b = a.config, e = b.baseHref ? '<base href="' + b.baseHref + '"/>' : "", i = CKEDITOR.env.isCustomDomain();
        ...
        CKEDITOR.plugins.add("preview", {init: function (a) {
            a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && (h = this.path, a.addCommand("preview", j), a.ui.addButton && a.ui.addButton("Preview", {label: a.lang.preview.preview, command: "preview", toolbar: "document,40"}))
        }})
    })();
    ...
    CKEDITOR.plugins.add("specialchar", {availableLangs: {ca: 1, cs: 1, cy: 1, de: 1, en: 1, eo: 1, et: 1, fa: 1, fi: 1, fr: 1, he: 1, hr: 1, it: 1, ku: 1, lv: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, sk: 1, sv: 1, th: 1, tr: 1, ug: 1, "zh-cn": 1}, requires: "dialog", init: function (a) {
        var c = this;
