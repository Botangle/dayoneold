 ...
 */
CKEDITOR.plugins.setLang("a11yhelp", "pl", {title: "Instrukcje dostępności", contents: "Zawartość pomocy. Wciśnij ESC, aby zamknąć to okno.", legend: [
    {name: "Ogólne", items: [
    ...
    {name: "Polecenia",
        items: [
            {name: "Cofnij polecenie", legend: "Wciśnij ${undo}"},
            {name: "Ponów polecenie", legend: "Wciśnij ${redo}"},
            {name: "Polecenie pogrubienia", legend: "Wciśnij ${bold}"},
            {name: "Polecenie kursywy", legend: "Wciśnij ${italic}"},
            {name: "Polecenie podkreślenia", legend: "Wciśnij ${underline}"},
            {name: "Polecenie hiperłącza", legend: "Wciśnij ${link}"},
            {name: "Polecenie schowaj pasek narzędzi", legend: "Wciśnij ${toolbarCollapse}"},
            ...
            {name: "Pomoc dostępności", legend: "Wciśnij ${a11yHelp}"}
        ]}
]});