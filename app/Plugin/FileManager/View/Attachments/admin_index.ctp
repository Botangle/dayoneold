...
<table class="table table-striped">
    ...
    $mimeType = $mimeType['0'];
    if ($mimeType == 'image') {
    $imgUrl = $this->Image->resize('/uploads/' . $attachment['Attachment']['slug'], 100, 200, true, array('class' =>
    'img-polaroid', 'alt' => $attachment['Attachment']['title']));
    ...
    $thumbnail = $this->Html->image('/croogo/img/icons/page_white.png', array('alt' =>
    $attachment['Attachment']['mime_type'])) . ' ' . $attachment['Attachment']['mime_type'] . ' (' .
