				...
				<div class="StaticPageRight-Block">
					<div class="PageLeft-Block">
                        ...
                        */
							...
							<div class="row-fluid">
								<div class="control-group">
									...
									<div class="form-group span4 controls">
										<?php
                                        //echo $this->Html->image($user['User']['profilepic'], array('class' => 'img-circle img-profilepic')); ?>
									</div>
								</div>
							</div>
						<?php else : ?>
						...
						<div class="row-fluid">
							<div class="control-group">
								<label class="control-label" for="firstName"><?php echo trans("Username:") ?></label>
								<div class="controls">
						...
						<div class="row-fluid">
							<div class="control-group">
								<label class="control-label" for="firstName"><?php echo trans("First Name:") ?></label>
								<div class="controls">
